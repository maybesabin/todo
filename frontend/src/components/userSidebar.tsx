...
const userSidebar = ({ showSidebar, setShowSidebar, showSearchPopup, setShowSearchPopup }: PropsType) => {
    ...
    return (
        <div
            ref={sidebarRef}
            className={`${showSidebar ? "visible -translate-x-0" : "invisible -translate-x-full"} md:hidden flex flex-col items-start justify-between transition-all duration-300 ease-in-out fixed z-999 bg-white h-screen left-0 w-80 -mt-6`}
        >
